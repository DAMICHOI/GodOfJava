...
public class StringCheck {
	...
	public void checkAddress(String[] addresses) {
		...
		System.out.println("Strart with " + startText + " count is " + startCount);
	...
	public void checkMatch() {
		...
		System.out.println(text.regionMatches(2, compare, 0, 1));    // 매개 변수가 4개인 메소드
		System.out.println(text.regionMatches(5, compare, 0, 2));    // 매개 변수가 4개인 메소드
	...
	public void checkTrim() {
		String strngs[] = new String[] {
			" a", " b ", "    c", "d    ", "e   f", "   "
		};
		for (String string : strngs) {
